...
$fsphp = new \Source\Interpretatition\Product();
$fsphp->handle("Fullstack Php Developer", 1997);
...
echo "<p>O curso {$fsphp->title} da {$fsphp->company} é o melhor curso do mercado</p>";
...
unset($fsphp->name, $fsphp->price, $fsphp->data);