...
if(!file_exists($file) || !is_file($file)){
    ...
    fwrite($fileOpen, "Linha 03".PHP_EOL);
    fwrite($fileOpen, "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the".PHP_EOL);
    fclose($fileOpen);
}else{
    var_dump(
      file($file),
...
if(file_exists($getContents) && is_file($getContents)) {
    ...
    $data = "<article><h1>Fernando</h1><p>Teste</p></article>";
