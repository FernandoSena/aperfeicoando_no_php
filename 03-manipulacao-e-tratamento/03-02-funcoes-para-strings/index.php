...
$string = "O últiimo show do AC/DC foi íncrivel";

var_dump([
    "String"=>$string,
    "strlen"=>strlen($string),
    "mb_strlen"=>mb_strlen($string),
    "substrt"=>substr($string, "9"),
    "mb_substrt"=>mb_substr($string, "9"),
...
echo "<p>",str_replace(["AC/DC", "íncrivel"],["Nirvana", "épico"],$mbStrReplace),"</p>";
...
$endPoint = "name=fernando&email=fernandocarvalho.sena@gmail.com";
mb_parse_str($endPoint, $novaVariavel);
